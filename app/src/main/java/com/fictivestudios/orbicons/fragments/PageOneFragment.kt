...
class PageOneFragment : Fragment() {
    ...
    override fun onCreateView(
       ...
       mView = inflater.inflate(R.layout.fragment_page_one, container, false)
    ...
    private fun setRecyclerView() {
        ...
        mView.rv_page1_icons.adapter = context?.let { AlliconsAdapter(it, pageOneIconsList) }
        mView.rv_page1_icons.adapter?.notifyDataSetChanged()
