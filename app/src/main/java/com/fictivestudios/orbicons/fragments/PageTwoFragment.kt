...
import com.fictivestudios.orbicons.utils.pageTwoIconsList
...
import kotlinx.android.synthetic.main.fragment_page_two.view.*
...
class PageTwoFragment : Fragment() {
    ...
    override fun onCreateView(
       ...
       mView =  inflater.inflate(R.layout.fragment_page_two, container, false)
    ...
    private fun setRecyclerView() {
        ...
        mView.rv_page2_icons.adapter = context?.let { AlliconsAdapter(it, pageTwoIconsList) }
        mView.rv_page2_icons.adapter?.notifyDataSetChanged()
